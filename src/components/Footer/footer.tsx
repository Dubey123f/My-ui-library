...
//     <motion.path
//       key={index} // Add this line to provide a unique key
//       custom={index}
//       variants={variants}
//       d={path}
//       fill='#3E7AEE'
          ...
          <div className="md:flex justify-between w-full">
              ...
              <div className="pt-2 pb-6">
                ...
                <div className="relative bg-black flex justify-between items-center border-2 overflow-hidden border-black rounded-full text-white md:text-2xl">
                  <form onSubmit={handleNewsLetterData} className="relative grid grid-cols-6 w-full h-full">
                    ...
                    <button
                      type="submit"
                      className="cursor-pointer w-full bg-white text-black h-full"
            ...
            <div className="flex gap-10">
              <ul>
                ...
                {['Home', 'About us', 'Our Services', 'Projects', 'Blogs', 'Contact'].map((item) => (
                  <li className="text-xl font-medium" key={item}>
              ...
              <ul>
                ...
                {[
                  { name: 'LinkedIn', url: 'https://www.linkedin.com/company/next-codez/' },
                  { name: 'Twitter', url: 'https://twitter.com/NextCodez' },
                  { name: 'Instagram', url: 'https://www.instagram.com/nextcodez/' },
                  { name: 'Facebook', url: 'https://www.facebook.com/nextcodezz' },
                ].map((social) => (
                  <li className="text-xl font-medium" key={social.name}>
                    <a href={social.url} target="_blank" rel="noopener noreferrer" className="underline">
                      {social.name}
                    </a>
                  </li>
                ))}
