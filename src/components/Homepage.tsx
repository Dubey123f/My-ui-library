...
//   return (
//     <div className="flex h-screen">
//     <div className="flex h-screen bg-gradient-to-r from-gray-800 to-purple-600"></div>
//       {/* Sidebar */}
//       <aside className="w-64 bg-gray-800 text-white p-6">
//         <h2 className="text-2xl font-semibold mb-4">My UI Library</h2>
//         <nav>
...
//             <li className="mb-2">
//               <Link href="#h" legacyBehavior>
//                 <a className="text-blue-500 hover:underline">Go</a>
//               </Link>
//             </li>
//             <li className="mb-2">
//               <Link href="#home" legacyBehavior>
...
//         {/* Main Content */}
//         <main className="flex-1 p-6">
//           <h2 className="text-2xl font-semibold mb-4">Explore Components</h2>
//           <p className="text-gray-600 mb-8">Choose from a variety of components to enhance your web applications.</p>
...
//           }
//           100% {
//             background-color: #1a202c; /* Back to dark gray */
//           }
//         }
